...
## Procedimiento
1. Se seleccionó la placa **ESP32 Wrover Module** con **PSRAM habilitada**.
2. Se cargó el ejemplo `CameraWebServer` modificando el archivo de pines para el modelo `AI_THINKER`.
3. Se verificó la conexión exitosa mediante el Monitor Serial.
